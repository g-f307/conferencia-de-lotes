...
def test_read_workbook_adds_origin_date_and_original_order(tmp_path):
    ...
    assert result.registros[4]["aba_origem"] == "Insp_16_06_2026"
    assert result.registros[4]["data_referencia"] == "2026-06-16"
    assert result.registros[4]["ordem_linha"] == 1
